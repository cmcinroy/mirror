...
/**
 * A helper class to regularly retrieve tweets.
 */
public class Twitter extends DataUpdater<List<String>> {
  private static final String TAG = Twitter.class.getSimpleName();

  /**
   * Twitter API key to allow app to read tweets.
   */
  final static String TWITTER_API_KEY = "M0q4TV2It9zRL5kYN1Cycs5bV";
  final static String TWITTER_API_SECRET = "sRO7LXcTJM903Fujx8B0JpNpQ64KXlLjArMZUJS2HJtQLVSf2R";
  /**
  ...
  /**
   * The time in milliseconds between API calls to update tweets.
   */
  ...
  public Twitter(UpdateListener<List<String>> updateListener) {
